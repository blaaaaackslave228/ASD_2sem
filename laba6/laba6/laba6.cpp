...
{
    int num;
    cout << "Введите номер телефона, который вы хотите найти: ";
    cin >> num;
...
int main()
{
    ...
    int choice;
    cout << "1 - Добавление элемента в хеш-таблицу" << endl;
    cout << "2 - Удаление элемента хеш-таблицы" << endl;
    cout << "3 - Поиск элемента хеш-таблицы" << endl;
